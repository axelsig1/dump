...
class TrafficSystem1:
    ...
    def number_in_system(self):
        ...
        for road in [str(self.lane1), str(self.lane2), self.queue]:
            if type(road) == str:   # Om road är av typen str
                road = road[1:-1]   # Ta bort '[' + ']' från road
            ...
            for x in range(len(road)):  # Lägg till alla forden som är i filen till listan
                if road[x] == '.':
                    ...
                    number_in_system += 1
        return number_in_system  # Returnerar bilarna i systemet
...
"""
NÃ¤r koden körs bör följande skrivas ut
   0: ( 0) [.....](G)[.....]  []
   1: ( 0) [.....](G)[....S]  []
   2: ( 0) [.....](G)[...SS]  []
   3: ( 0) [.....](G)[..SSS]  []
